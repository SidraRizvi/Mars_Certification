...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("I should be getting the same view on accessing Mars from different versions of Ch" +
            "rome browser")]
        [NUnit.Framework.CategoryAttribute("Home@SignIn@CrossbrowerTesting")]
        public virtual void IShouldBeGettingTheSameViewOnAccessingMarsFromDifferentVersionsOfChromeBrowser()
        {
            string[] tagsOfScenario = new string[] {
...
#line hidden
#line 72
testRunner.When("I enter Home URL in chrome browser of <version>", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 73
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("Home@SignIn@PerformanceTesting")]
        public virtual void WhenIEnterURlTheLoginScreenShouldBeLoadedWithinTheDefinedTime()
        {
            string[] tagsOfScenario = new string[] {
                    "Home@SignIn@PerformanceTesting"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("When I enter URl, the Login screen should be loaded within the defined time", null, new string[] {
                        "Home@SignIn@PerformanceTesting"});
#line 82
this.ScenarioInitialize(scenarioInfo);
#line hidden
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("When I Sign in from my Mobile/Desktop/Tablet, application should work properly in" +
            " different platforms")]
        [NUnit.Framework.CategoryAttribute("Home@SignIn@CompatabilityTesting")]
        public virtual void WhenISignInFromMyMobileDesktopTabletApplicationShouldWorkProperlyInDifferentPlatforms()
        {
            string[] tagsOfScenario = new string[] {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("When I Sign in from my Mobile/Desktop/Tablet, application should work properly in" +
                    " different platforms", null, new string[] {
                        "Home@SignIn@CompatabilityTesting"});
#line 88
 this.ScenarioInitialize(scenarioInfo);
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 90
 testRunner.Given("User has installed correct browser version and other prerequisite", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 91
