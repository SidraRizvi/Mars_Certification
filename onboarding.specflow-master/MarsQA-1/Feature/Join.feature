...
Scenario: I should be getting the same view on accessing Mars from different versions of Chrome browser
...
Then Home Page should be loaded within standard time of 5-10 seconds
 ...
 Scenario: When I Sign in from my Mobile/Desktop/Tablet, application should work properly in different platforms 

 Given User has installed correct browser version and other prerequisite
